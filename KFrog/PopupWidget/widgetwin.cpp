...
const QPixmap& WidgetWin::pixFail() {
	static const QPixmap pix(":/imagePng/PNG/FROG_DLG_BG.png");
	return pix;
}
...
{
	this->m_buttonREPLAY = new ImageButton(":/imagePng/PNG/FROG_DLG_REPLAY.png", this, QPoint(30, 130), 3);
	this->m_buttonEND = new ImageButton(":/imagePng/PNG/FROG_DLG_END.png", this, QPoint(200, 130), 3);
	this->m_buttonNEXT = new ImageButton(":/imagePng/PNG/FROG_DLG_NEXT.png", this, QPoint(115, 130), 3);
